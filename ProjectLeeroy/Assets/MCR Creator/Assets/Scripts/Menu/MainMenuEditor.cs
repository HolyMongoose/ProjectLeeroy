...
// --> Section 2 - Add New Scene to the list
		...
		if(b_CreateNewButton)																		// --> Create a new Button
		{
			...
			myScript.TableSpriteList.Insert(0, Sprite.Create(Texture2D.blackTexture, new Rect(0,0, 100, 100), Vector2.zero));
			myScript.TableBackgroundSpriteList.Insert(0,Sprite.Create(Texture2D.blackTexture, new Rect(0, 0, 100, 100), Vector2.zero));
